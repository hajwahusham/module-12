-- create the nobel_win table if not exists
...
-- SELECT ALL RECORDS FROM NOBEL_WIN WHERE THE SUBJECT DOES NOT START WITH P
SELECT * FROM NOBEL_WIN
WHERE SUBJECT NOT LIKE 'P%';

SELECT WINNER  || '(' || SUBSTR(SUBJECT, 1, 1) || ')' AS WINNER FROM NOBEL_WIN;
